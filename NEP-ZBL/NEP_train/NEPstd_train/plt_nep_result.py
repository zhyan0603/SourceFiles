...
axs[0, 1].set_ylabel(r'NEP$_{std}$ energy (eV/atom)', fontsize=10)
...
axs[1, 0].set_ylabel(r'NEP$_{std}$ force (eV/$\AA$)', fontsize=10)
...
axs[1, 1].set_ylabel(r'NEP$_{std}$ stress (GPa)', fontsize=10)
