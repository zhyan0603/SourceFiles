...
axs[0, 1].set_ylabel(r'NEP$_{25}$-ZBL energy (eV/atom)', fontsize=10)
...
axs[1, 0].set_ylabel(r'NEP$_{25}$-ZBL force (eV/$\AA$)', fontsize=10)
...
axs[1, 1].set_ylabel(r'NEP$_{25}$-ZBL stress (GPa)', fontsize=10)
